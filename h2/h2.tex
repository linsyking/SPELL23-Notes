...
\begin{tcolorbox}
    \textsf{\textsf{ghci>}} testMN

    \lb z([0])(\lb \lb [1](y))

    \textsf{\textsf{ghci>}} testNM

    \lb \lb [1](y)(\lb z([0]))

    \textsf{\textsf{ghci>}} beta testMN

    z(\lb \lb [1](y))

    \textsf{\textsf{ghci>}} beta testNM

    \lb \lb z([0])(y)

    \textsf{\textsf{ghci>}} testM

    \lb z([0])

    \textsf{\textsf{ghci>}} testN
...
\begin{tcolorbox}
    ...
    \textsf{ghci>} nameless2normal testR

    \lb x0(x0) (\lb x1x0)

    \textsf{ghci>} normal2nameless \$ nameless2normal test

    testR  testT

    \textsf{ghci>} normal2nameless \$ nameless2normal testR
    ...
    \textsf{ghci>} normal2nameless testT

    \lb \lb ([0]) (y)

    \textsf{ghci>} nameless2normal \$ normal2nameless testT
